    ...
    <header id="header" class="main-header inner-page-header">
        <div class="custom-container">
            <div class="header-panel">
                ...
                <h3 class="fw-semibold title-color">Game Rates</h3>
            </div>
        </div>
    </header>
    <!-- header end -->
    ...
    <section class="pt-3">
        <div class="custom-container">
            <div class="poster-part">
                <p class="fw-normal text-white">Game Win Rate For All Bids</p>
            </div>
        </div>
    </section>
    <!-- note section end -->
                ...
                <li>
                    <div class="driver-box outstation-driver-box">
                        <div class="grid-btn mt-2">
                            <a href="#" class="btn gray-btn w-100 m-0">Single Digit : ₹ 9.7</a>
                        </div>
                        <div class="grid-btn mt-2">
                            <a href="#" class="btn gray-btn w-100 m-0">Jodi Digit : ₹ 97.0</a>
                        </div>
                        <div class="grid-btn mt-2">
                            <a href="#" class="btn gray-btn w-100 m-0">Red Bracket : ₹ 97.0</a>
                        </div>
                        <div class="grid-btn mt-2">
                            <a href="#" class="btn gray-btn w-100 m-0">Single Pana : ₹ 160.0</a>
                        </div>
                        <div class="grid-btn mt-2">
                            <a href="#" class="btn gray-btn w-100 m-0">Double Pana : ₹ 320.0</a>
                        </div>
                        <div class="grid-btn mt-2">
                            <a href="#" class="btn gray-btn w-100 m-0">Tripal Pana : ₹ 1000.0</a>
                        </div>
                        <div class="grid-btn mt-2">
                            <a href="#" class="btn gray-btn w-100 m-0">Half Sangam Digits : ₹ 1000.0</a>
                        </div>
                        <div class="grid-btn mt-2">
                            <a href="#" class="btn gray-btn w-100 m-0">Full Sangam Digits : ₹ 10000.0</a>
                        </div>
                    </div>
                </li>
            </ul>
